...
import { generateDaysFromYearBeginning } from '../utils/export const generateDaysFromYearBeginning'
  ...
  return(
    <div className="w-full flex">
      <div className="grid grid-rows-7 grid-flow-row gap-3">
        ...
        {weekDays.map(day => {
          return <div key={useId()} className="text-zinc-400 font-bold text-xl h-10 w-10 flex items-center justify-center">{day}</div>
        })}
